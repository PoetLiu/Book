/*
 *
 * Authored by Liu Peng on: Tue Nov  4 16:59:02 CST 2014
 *
 * @desc: a remote ls server - with paranoia
 *
 * @func:
**/
...
int main(int ac, char *av[])
{
	...
	FILE	*sock_fpi, *sock_fpo;		/* sreams for in and out */
...
/*
 * Funcion	: it would be very bad if someone passed us an dirname like
 *		  ";rm *" and we naivel created a command "ls; rm *"
 *		  so we remove everything but slashes and alphanumerics
 *		  ther are nices solutions, see execrises
 * return	:
**/
void sanitize(char *str)
{
