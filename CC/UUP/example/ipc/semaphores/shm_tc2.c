/*
 *
 * Authored by Liu Peng on: Mon Nov 10 17:21:50 CST 2014
 *
 * @desc: time client shared mem ver 2: use semaphores for locking
...
/*
 * Funcion	: build an execute a 2 - element action set
...
void wait_and_lock(int semset_id)
{
	...
	actions[0].sem_num	= 1;		/* set 1 is n_writers */
